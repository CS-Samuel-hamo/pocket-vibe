...
def _build_pairing_page_html(pairing: Dict[str, Any], qr_svg: Optional[str]) -> str:
    ...
    qr_markup = (
        f'<img src="{html.escape(str(pairing["qr_svg_url"]))}" alt="Pocket Vibe QR Code" loading="eager" />'
        if qr_svg
        else "<p style='color:#b91c1c'>QR generation is unavailable. Open the mobile link below on your phone.</p>"
    )
